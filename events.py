...
# a = 0 
# for a in range(len(events)):
#     c[a] = events[a]["timestamp"]
# min_ = c[0]
# for b in c:
#     if b < min_:
#         min_ = b
#         print(b)
# print(events[0]["sessionId"])
...
# a = 0 
# for a in range(len(events)):
#     c = events[a]["firstInSession"]
#     if c == True:
#         print(events[a]["pageViewId"])
    
    
# cars2 = ["Audi", "Audi", "bmw", "Audi", "rolce", "Audi", "Audi", "Audi", "sva", "Audi", "xxxx", "Audi"]
# # a = 0
# cars3 = []
# b = "Audi"
# c = 2
# a = 0
# for a in range(len(cars2)):
#     # print(cars2[a])
#     # print(cars2.index("rolce"))
#     print(cars2)
#     print(a)
#     if cars2[a] == b:
#         cars2.remove(b)
